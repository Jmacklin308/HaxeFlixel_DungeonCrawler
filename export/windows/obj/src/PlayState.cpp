...
HXLINE(  11)		 ::flixel::text::FlxText text =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,10,10,100,HX_("Hello there!",ab,ec,93,f8),null(),null());
HXLINE(  14)		this->add(text);
HXLINE(  20)		this->super::create();
            	}


void PlayState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_af23706db05c7feb_25_update)
HXDLIN(  25)		this->super::update(elapsed);
            	}
